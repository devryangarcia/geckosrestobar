                ...
                <div class="card card-success card-outline mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 mt-2">
                            ...
                            <a href="{{ route('bartenders.exportPDFAll') }}" target="_blank" class="btn btn-danger"
                                rel="noopener noreferrer">
                                <i class="fa fa-download"></i> Export PDF
                            </a>
                            <a href="{{ route('bartenders.exportExcel') }}" target="_blank" class="btn btn-primary"
                                rel="noopener noreferrer">
                        ...
                        <div class="modal fade" id="addbartender" tabindex="-1" aria-labelledby="addbartenderLabel"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <form action="{{ route('bartenders.store') }}" method="post">
                                        @csrf
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" id="bartender"
                                                    placeholder="Enter bartender" value="{{ old('name') }}">
                                            </div>
                                            @error('name')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-md btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#editbartender-{{ $bartender->id }}">
                                                <i class="fas fa-edit"></i> Edit
                                            </button>
                                            <!-- Modal -->
                                            <div class="modal fade" id="editbartender-{{ $bartender->id }}" tabindex="-1"
                                                aria-labelledby="addbartenderLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <form action="{{ route('bartenders.update',$bartender->id) }}" method="post">
                                                            @csrf
                                                            @method('put')
                                                            <div class="modal-header">
                                            ...
                                            <button type="button" class="btn btn-md btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deletebartender-{{ $bartender->id }}">
                                                <i class="fas fa-trash"></i> Delete
                                            </button>
                                            <!-- Modal -->
                                            <div class="modal fade" id="deletebartender-{{ $bartender->id }}"
                                                tabindex="-1" aria-labelledby="addbartenderLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-md">
                                                    <div class="modal-content">
                                                        <form action="{{ route('bartenders.delete',$bartender->id) }}" method="post">
                                                            @csrf
                                                            @method('delete')
                                                            <div class="modal-header">
                        ...
                        <div class="mt-3">
                            {{ $bartenders->links('pagination::bootstrap-5') }}
                        </div>
